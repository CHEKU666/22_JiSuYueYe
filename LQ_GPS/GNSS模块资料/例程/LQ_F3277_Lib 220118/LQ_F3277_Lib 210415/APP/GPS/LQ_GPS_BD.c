...
* @return   void
*
* @note     将串口收到的数据分门别类的保存到结构体中
*
* @see      $GNRMC,130416.000,A,2236.91843,N,11359.19128,E,0.001,306.28,090720,,,A*4F  
*
* @date     2021/12/15 星期三
*/
...
* @return   void
*
* @note     将结构体中的字符串转换成数据，有两种方式，#if 1：以小数点为分界。#if 0：自己手动调节
*
* @see      
*
* @date     2021/12/15 星期三
...
void Gps_test(void)
{
  ...
  //串口初始化为
  UART_InitConfig(UART1,115200,UART1_TX_A9,UART1_RX_A10);
